...
- (void)loadData:(BOOL)refresh {
    ...
    [self addLabel:@"Portrait" onCell:headerCell isHeaderCell:YES isLeft:YES];
    [self.cells1 addObject:headerCell];

    UITableViewCell *cell = [self getAttrCell:@"Nickname" rightText:self.userInfo.displayName mutable:YES];
    cell.tag = Modify_DisplayName;
    [self.cells1 addObject:cell];
    
    cell = [self getAttrCell:@"QRCode" rightText:@"" mutable:YES];
    cell.tag = 1000;
    [self.cells1 addObject:cell];
    ...
    cell = [self getAttrCell:@"Mobile" rightText:self.userInfo.mobile mutable:YES];
    cell.tag = Modify_Mobile;
    [self.cells2 addObject:cell];

    cell = [self getAttrCell:@"Gender" rightText: [self getGenderString:self.userInfo.gender] mutable:YES];
    cell.tag = Modify_Gender;
    [self.cells2 addObject:cell];

    cell = [self getAttrCell:@"Email" rightText:self.userInfo.email mutable:YES];
    cell.tag = Modify_Email;
    [self.cells2 addObject:cell];

    cell = [self getAttrCell:@"Address" rightText:self.userInfo.address mutable:YES];
    cell.tag = Modify_Address;
    [self.cells2 addObject:cell];

    cell = [self getAttrCell:@"Company" rightText:self.userInfo.company mutable:YES];
    cell.tag = Modify_Company;
    [self.cells2 addObject:cell];

    cell = [self getAttrCell:@"SocialAccount" rightText:self.userInfo.social mutable:YES];
